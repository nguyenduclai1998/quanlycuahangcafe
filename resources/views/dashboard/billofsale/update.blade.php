            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Sủa đơn hàng</li>
                    </ol>
                </nav>
            </div>
        </div>
	                ...
	                <div class="card-content">
	                    <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <form class="form form-vertical" action="{{route('update.billofsale', $bill->billId)}}" method="POST">
                                            @csrf
                                            <div class="form-body">
                                                            ...
                                                            <select class="choices form-select" name="table_id">
                                                                ...
                                                                @if(isset($table))
                                                                    @foreach($table as $element)
                                                                        <option value="{{$element->id}}" {{$element->id == $bill->id ? "selected='seleted'" : ""}}>Bàn {{$element->number}}</option>
                                                                    @endforeach
                                                                @endif
                                                            </select>
                                                        </fieldset>
                                                    ...
                                                    @if(isset($billDetail))
                                                        @foreach($billDetail as $value)
                                                            <div class="row" data-product-id="{{$value->id}}">
                                                                ...
                                                                <div class="col-2">
                                                                    <div class="form-group">
                                                                        <input type="number" data-product-id="{{$value->id}}" data-action="changeAction" class="form-control" name="unit[]" placeholder="SL" value="{{$value->amount}}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-2">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-3">
                                                                    <div class="form-group">
                                                                        <input type="number" data-action="changeAction" style="pointer-events:none; border: none" class="form-control" name="totalPrice[]" id="totalPrice_{{$value->id}}" data-product-id="{{$value->id}}" value="{{$value->price * $value->amount}}" >
                                                                    </div>
                                                                </div>
                                                                <div class="col-2">
                                                                   <button type="button" class="btn btn-primary"  data-product-id2="{{$value->id}}" data-action="minusField"></button>
